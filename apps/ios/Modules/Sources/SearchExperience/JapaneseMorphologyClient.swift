...
struct JapaneseMorphologyClient: Sendable {
  ...
  static func sudachiCore(dictionaryURL: URL) throws -> JapaneseMorphologyClient {
    ...
    static let uiTestFixture = JapaneseMorphologyClient { text in
      ...
      case "いるだけ持っていらっしゃい。":
        annotated = [
          ("いる", "いる", "イル", "動詞"), ("だけ", "だけ", "ダケ", "助詞"),
          ("持っ", "持つ", "モッ", "動詞"), ("て", "て", "テ", "助詞"),
          ("いらっしゃい", "いらっしゃる", "イラッシャイ", "動詞"),
          ("。", "。", "。", "補助記号"),
        ]
      case "見るからに明らかだよ。":
        annotated = [
          ("見る", "見る", "ミル", "動詞"), ("から", "から", "カラ", "助詞"),
          ("に", "に", "ニ", "助詞"), ("明らか", "明らか", "アキラカ", "形状詞"),
          ("だ", "だ", "ダ", "助動詞"), ("よ", "よ", "ヨ", "助詞"),
          ("。", "。", "。", "補助記号"),
        ]
      case "見ることは信ずることなり。":
        annotated = [
          ("見る", "見る", "ミル", "動詞"), ("こと", "こと", "コト", "名詞"),
          ("は", "は", "ハ", "助詞"), ("信ずる", "信ずる", "シンズル", "動詞"),
          ("こと", "こと", "コト", "名詞"), ("なり", "なり", "ナリ", "助動詞"),
          ("。", "。", "。", "補助記号"),
        ]
      case "食べるために生きてるんじゃない。生きるために食べてるんだ。":
        annotated = [
          ("食べる", "食べる", "タベル", "動詞"), ("ため", "ため", "タメ", "名詞"),
          ("に", "に", "ニ", "助詞"), ("生き", "生きる", "イキ", "動詞"),
          ("てる", "てる", "テル", "助動詞"), ("ん", "ん", "ン", "助詞"),
          ("じゃ", "だ", "ジャ", "助動詞"), ("ない", "ない", "ナイ", "形容詞"),
          ("。", "。", "。", "補助記号"), ("生きる", "生きる", "イキル", "動詞"),
          ("ため", "ため", "タメ", "名詞"), ("に", "に", "ニ", "助詞"),
          ("食べ", "食べる", "タベ", "動詞"), ("てる", "てる", "テル", "助動詞"),
          ("ん", "ん", "ン", "助詞"), ("だ", "だ", "ダ", "助動詞"),
          ("。", "。", "。", "補助記号"),
        ]
      case "来る日も来る日も雨だった。":
        annotated = [
          ("来る", "来る", "クル", "動詞"), ("日", "日", "ヒ", "名詞"),
          ("も", "も", "モ", "助詞"), ("来る", "来る", "クル", "動詞"),
          ("日", "日", "ヒ", "名詞"), ("も", "も", "モ", "助詞"),
          ("雨", "雨", "アメ", "名詞"), ("だっ", "だ", "ダッ", "助動詞"),
          ("た", "た", "タ", "助動詞"), ("。", "。", "。", "補助記号"),
        ]
      case "水は見る見るうちに橋げたのところまで達した。":
        annotated = [
          ("水", "水", "ミズ", "名詞"), ("は", "は", "ハ", "助詞"),
          ("見る見る", "見る見る", "ミルミル", "副詞"), ("うち", "うち", "ウチ", "名詞"),
          ("に", "に", "ニ", "助詞"), ("橋げた", "橋げた", "ハシゲタ", "名詞"),
          ("の", "の", "ノ", "助詞"), ("ところ", "ところ", "トコロ", "名詞"),
          ("まで", "まで", "マデ", "助詞"), ("達し", "達する", "タッシ", "動詞"),
          ("た", "た", "タ", "助動詞"), ("。", "。", "。", "補助記号"),
        ]
      case "REM睡眠中の脳波は起きている時と同じ脳波であり、夢を見るステージです。":
        annotated = [
          ("REM", "REM", "アールイーエム", "名詞"), ("睡眠", "睡眠", "スイミン", "名詞"),
          ("中", "中", "チュウ", "接尾辞"), ("の", "の", "ノ", "助詞"),
          ("脳波", "脳波", "ノウハ", "名詞"), ("は", "は", "ハ", "助詞"),
          ("起き", "起きる", "オキ", "動詞"), ("て", "て", "テ", "助詞"),
          ("いる", "いる", "イル", "動詞"), ("時", "時", "トキ", "名詞"),
          ("と", "と", "ト", "助詞"), ("同じ", "同じ", "オナジ", "連体詞"),
          ("脳波", "脳波", "ノウハ", "名詞"), ("で", "だ", "デ", "助動詞"),
          ("あり", "ある", "アリ", "動詞"), ("、", "、", "、", "補助記号"),
          ("夢", "夢", "ユメ", "名詞"), ("を", "を", "ヲ", "助詞"),
          ("見る", "見る", "ミル", "動詞"), ("ステージ", "ステージ", "ステージ", "名詞"),
          ("です", "です", "デス", "助動詞"), ("。", "。", "。", "補助記号"),
        ]
      default:
        annotated = nil
