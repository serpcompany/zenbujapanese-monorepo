# Search experience regression index

This is the living index for Search capability coverage and retained journey
evidence. It describes current public seams without turning historical test
totals into current release claims. The frozen bounded version 1.0 result is in
the [Search acceptance record](../../../docs/releases/1.0.0/verification/search-acceptance.md).

The durable user-facing regression checklist is maintained in
[`PHYSICAL-DEVICE-QA/README.md`](PHYSICAL-DEVICE-QA/README.md).
It maps each physical-device complaint to its exact automated public seam and
the remaining manual TestFlight check.

Historical Nihongo evidence remains authoritative only within the
[reference-authority boundary](../../../docs/clone-discovery/nihongo/REFERENCE-AUTHORITY.md).
Current-version parity requires the bounded replay owned by #168; this living
index alone cannot merge or close parity work.
...
Historical frozen-candidate runs and the retained records below remain journey evidence; current candidate totals belong in the active release handoff rather than being copied into this capability narrative. The [whole-product acceptance record](WHOLE-PRODUCT-ACCEPTANCE/README.md), retained [Search-text evidence index](JOURNEY-SEARCH-TEXT-v3/README.md), [romaji-refinement evidence index](JOURNEY-SEARCH-ROMAJI-REFINEMENT/README.md), [recent-Search evidence index](JOURNEY-RERUN-RECENT-SEARCH/README.md), [handwriting-Search evidence index](JOURNEY-SEARCH-HANDWRITING-v2/README.md), [radical-Search evidence index](JOURNEY-SEARCH-RADICAL-v2/README.md), [Word Detail evidence index](JOURNEY-INSPECT-WORD-v5/README.md), [Example Sentences evidence index](JOURNEY-READ-EXAMPLES-v2/README.md), [pronunciation evidence index](JOURNEY-HEAR-PRONUNCIATION-v2/README.md), [conjugation evidence index](JOURNEY-INSPECT-CONJUGATIONS/README.md), [word-note evidence index](JOURNEY-EDIT-NOTE/README.md), [Kanji Detail evidence index](JOURNEY-INSPECT-KANJI/README.md), [stroke-order evidence index](JOURNEY-PLAY-STROKE-ORDER/README.md), [Kanji element evidence index](JOURNEY-INSPECT-KANJI-ELEMENT/README.md), [Image Text evidence index](JOURNEY-IMAGE-FILES/README.md), and machine-readable attachment manifests cover the accepted public states.
...
The deterministic Kanjium adaptation contains 1,698 elements, 6,656 kanji with elements, 14,874 relationships, and 1,238 alternative relationships. The [Kanji element evidence record](JOURNEY-INSPECT-KANJI-ELEMENT/README.md) retains three settled states from the exact 49/49 passing bundle plus two settled states from the immediately preceding 3/3 run of the same final code, records source/artifact checksums and attribution, and names the open-source phonetic-model, environment, recovery, ordering, and later Kanji-note boundaries.
...
The v4 note store normalizes empty/whitespace-only rows, serializes every full-array save, and makes Back await the newest scheduled write. The [word-note evidence record](JOURNEY-EDIT-NOTE/README.md) retains seven settled lifecycle states from the exact 40/40 passing bundle and names the platform-keyboard exclusion, private-storage/whitespace differences, and uncaptured validation/failure boundaries.
...
app-owned word classes and lexical forms. The [conjugation evidence record](JOURNEY-INSPECT-CONJUGATIONS/README.md)
...
The [journey evidence record](JOURNEY-HEAR-PRONUNCIATION-v2/README.md) retains the settled public speaker surfaces and names the platform-audio substitution, acoustic-observability limit, simulator difference, and uncaptured interruption/route/failure boundaries.
...
The [journey evidence record](JOURNEY-RERUN-RECENT-SEARCH/README.md) retains only reset, session-created synthetic history and records the reference persistence evidence gap, approved per-row deletion decision, and destructive-reference boundary. No claim is made about Nihongo's uncaptured storage location, cold-relaunch persistence, exact swipe mechanics, or destructive Clear All outcome.
