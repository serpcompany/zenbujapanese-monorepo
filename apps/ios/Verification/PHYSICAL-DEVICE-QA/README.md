...
| Recorded `山` handwriting | The exact recorded gesture—left L/down-right stroke, center vertical, right vertical—offers `山`. | `testRecordedPhysicalPhoneYamaGestureIncludesYamaCandidate` | Draw naturally with a fingertip; do not imitate test coordinates. |
