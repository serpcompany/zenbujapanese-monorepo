...
Zenbu will implement direct English Example Sentence Retrieval with the SQLite FTS4 module and its built-in `porter` tokenizer supplied by Apple's iOS `libsqlite3`. FTS supplies only an unordered set of English eligibility candidates. An app-owned, provider-independent policy establishes Example Sentence Matches, filters them, and applies Example Sentence Ranking. Japanese direct retrieval and dictionary-entry association remain separate routes. This follows [ADR 0001](0001-keep-language-data-and-tools-replaceable.md), the archived [retrieval research](https://github.com/zenbujapanese/research/blob/main/language-technology/example-sentence-retrieval/archive/issue-147-report/example-sentence-retrieval-language-technology-2026-08-14.md), and the archived [Nihongo artifact audit](https://github.com/zenbujapanese/research/blob/main/language-technology/example-sentence-retrieval/archive/issue-149-artifact-audit/nihongo-example-retrieval-artifact-audit-2026-08-14.md).
