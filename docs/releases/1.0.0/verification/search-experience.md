...
[`Verification/PHYSICAL-DEVICE-QA/README.md`](../../../../apps/ios/Verification/PHYSICAL-DEVICE-QA/README.md).
...
Historical frozen-candidate runs and the retained records below remain journey evidence; current candidate totals belong in the active release handoff rather than being copied into this capability narrative. The [whole-product acceptance record](../../../../apps/ios/Verification/WHOLE-PRODUCT-ACCEPTANCE/README.md), retained [Search-text evidence index](../../../../apps/ios/Verification/JOURNEY-SEARCH-TEXT-v3/README.md), [romaji-refinement evidence index](../../../../apps/ios/Verification/JOURNEY-SEARCH-ROMAJI-REFINEMENT/README.md), [recent-Search evidence index](../../../../apps/ios/Verification/JOURNEY-RERUN-RECENT-SEARCH/README.md), [handwriting-Search evidence index](../../../../apps/ios/Verification/JOURNEY-SEARCH-HANDWRITING-v2/README.md), [radical-Search evidence index](../../../../apps/ios/Verification/JOURNEY-SEARCH-RADICAL-v2/README.md), [Word Detail evidence index](../../../../apps/ios/Verification/JOURNEY-INSPECT-WORD-v5/README.md), [Example Sentences evidence index](../../../../apps/ios/Verification/JOURNEY-READ-EXAMPLES-v2/README.md), [pronunciation evidence index](../../../../apps/ios/Verification/JOURNEY-HEAR-PRONUNCIATION-v2/README.md), [conjugation evidence index](../../../../apps/ios/Verification/JOURNEY-INSPECT-CONJUGATIONS/README.md), [word-note evidence index](../../../../apps/ios/Verification/JOURNEY-EDIT-NOTE/README.md), [Kanji Detail evidence index](../../../../apps/ios/Verification/JOURNEY-INSPECT-KANJI/README.md), [stroke-order evidence index](../../../../apps/ios/Verification/JOURNEY-PLAY-STROKE-ORDER/README.md), [Kanji element evidence index](../../../../apps/ios/Verification/JOURNEY-INSPECT-KANJI-ELEMENT/README.md), [Image Text evidence index](../../../../apps/ios/Verification/JOURNEY-IMAGE-FILES/README.md), and machine-readable attachment manifests cover the accepted public states.

## App-owned Image Text Flow

Search now starts a transient Image Text session from one or more real Files selections. The flow performs bounded, cancellable Apple Vision recognition; overlays selectable Japanese regions across horizontal, noisy, sparse, and vertical layouts; opens canonical gloss and Word Detail destinations with Photo context; copies raw recognized lines; shares the selected image; and returns or closes through public controls. Opening a recognized word retains the source as Encounter Media associated with that word; distinct later images accumulate, identical bytes are deduplicated, and unopened words remain transient. Word Detail removes one association, while the Media Library browses and deletes retained media. Empty OCR is page-local, while recognized Japanese without a dictionary match remains honestly recognized rather than becoming a false no-text alert.

Natural Translation is an explicit shared-capability action available only after source text loads. Settled translations survive nested Word Detail navigation within the active session, while page changes, Close, and relaunch clear transient flow state. Encounter Media is the narrow persistence exception and does not retain OCR regions or translations. The [Image Text evidence record](../../../../apps/ios/Verification/JOURNEY-IMAGE-FILES/README.md) retains eight final states from the exact 54/54 passing bundle plus a complete-chrome translation state from the immediately preceding 2/2 focused run of the same final product code, and names the Vision, translation, serialization, environment, privacy, asset, source-exclusion, failure, and share-sheet boundaries.
...
The deterministic Kanjium adaptation contains 1,698 elements, 6,656 kanji with elements, 14,874 relationships, and 1,238 alternative relationships. The [Kanji element evidence record](../../../../apps/ios/Verification/JOURNEY-INSPECT-KANJI-ELEMENT/README.md) retains three settled states from the exact 49/49 passing bundle plus two settled states from the immediately preceding 3/3 run of the same final code, records source/artifact checksums and attribution, and names the open-source phonetic-model, environment, recovery, ordering, and later Kanji-note boundaries.
...
The v4 note store normalizes empty/whitespace-only rows, serializes every full-array save, and makes Back await the newest scheduled write. The [word-note evidence record](../../../../apps/ios/Verification/JOURNEY-EDIT-NOTE/README.md) retains seven settled lifecycle states from the exact 40/40 passing bundle and names the platform-keyboard exclusion, private-storage/whitespace differences, and uncaptured validation/failure boundaries.
...
app-owned word classes and lexical forms. The [conjugation evidence record](../../../../apps/ios/Verification/JOURNEY-INSPECT-CONJUGATIONS/README.md)
...
The [journey evidence record](../../../../apps/ios/Verification/JOURNEY-HEAR-PRONUNCIATION-v2/README.md) retains the settled public speaker surfaces and names the platform-audio substitution, acoustic-observability limit, simulator difference, and uncaptured interruption/route/failure boundaries.
...
The [journey evidence record](../../../../apps/ios/Verification/JOURNEY-RERUN-RECENT-SEARCH/README.md) retains only reset, session-created synthetic history and records the reference persistence evidence gap, approved per-row deletion decision, and destructive-reference boundary. No claim is made about Nihongo's uncaptured storage location, cold-relaunch persistence, exact swipe mechanics, or destructive Clear All outcome.
