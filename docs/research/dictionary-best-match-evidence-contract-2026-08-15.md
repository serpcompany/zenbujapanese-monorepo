...
- [ADR 0001](../adr/0001-keep-language-data-and-tools-replaceable.md) requires app-owned models with source provenance separate from provider schema. [ADR 0002](../adr/0002-example-sentence-retrieval-contract.md) owns Example Sentence Match/Ranking separately; this work does not alter it.
