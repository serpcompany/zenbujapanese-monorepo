...
- Keep canonical domain language and architectural decisions at the repository level (`CONTEXT.md` and `docs/adr/`). Keep iOS-only product behavior beside the app in `apps/ios/docs/product/`.
